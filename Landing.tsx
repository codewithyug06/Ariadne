...
export function Landing({
  ...
  // Standalone mode: using navigation callbacks or window.location
          ...
          <nav className="pill-navbar" aria-label="Main Navigation">
            ...
            <div className="nav-actions">
              {authStatus === 'authenticated' ? (
                <GlassButton size="sm" onClick={onLaunchDashboard} className="nav-glass-btn">
                  Console Dashboard →
                </GlassButton>
              ) : (
                <>
          ...
          <div id="modalSuccessView" className="modal-success">
            ...
            <button
              ...
              onClick={() => {
                ...
                if (onLaunchDashboard) { onLaunchDashboard(); } else { window.location.href = '/'; }
              }}
            >
              Launch Dashboard →
            </button>
